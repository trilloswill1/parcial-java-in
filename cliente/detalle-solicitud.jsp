...
String idPropiedad = "0", titulo = null, precio = null, direccion = null, ciudadNombre = null;
...
if (idSolicitud <= 0) {
    ...
    if (esPostDoc) {
        ...
        if (nombre.isEmpty()) {
            ...
            if (errorDocumento == null && !duena) {
                errorDocumento = "No puedes agregar documentos a una solicitud que no te pertenece.";
            }
    ...
    try {
        ps = conexion.prepareStatement(
            ...
            "p.id_propiedad, p.titulo, p.precio, p.direccion, cd.nombre AS ciudad_nombre, " +
        ...
        if (rs.next()) {
            ...
            errorDetalle = "La solicitud solicitada no existe o no te pertenece.";
        }
        cerrar(rs, ps);
...
<% if (documentoRegistrado) {
    response.sendRedirect(ctx + "/cliente/detalle-solicitud.jsp?id=" + idSolicitud + "&docok=1");
    return;
} %>
...
<div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
    ...
    <a href="<%= ctx %>/cliente/solicitudes.jsp" class="btn btn-outline-secondary">Volver a mis solicitudes</a>
</div>

<% if ("1".equals(request.getParameter("ok"))) { %>
<div class="alert alert-success" role="alert">Solicitud creada correctamente.</div>
<% } %>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <p class="text-muted small">
                    Registra la referencia de un documento (cédula, carta de crédito, certificado de ingresos, avalúo o contrato) para tu solicitud.
                </p>
                <form method="post" action="<%= ctx %>/cliente/detalle-solicitud.jsp?id=<%= idSolicitud %>">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="nombre_archivo" name="nombre_archivo" class="form-control"
                               maxlength="255" placeholder="Ej.: cedula.pdf">
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="url_archivo" name="url_archivo" class="form-control"
                               maxlength="500" placeholder="Ej.: /docs/sol6/cedula.pdf">
                    </div>
